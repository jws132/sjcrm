...
<div class="widget-box">
          ...
          <div class="widget-content">
                    <form class="form-horizontal" form action="<?php echo U('AddField');?>" method="post">
                                        ...
                                        <label class="control-label">数据类型</label>
                                          <div class="controls">
                                            <select name="type">
                                              ...
                                              <?php $_result=get_attribute_type();if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" role="<?php echo ($type[1]); ?>" ><?php echo ($type[0]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
