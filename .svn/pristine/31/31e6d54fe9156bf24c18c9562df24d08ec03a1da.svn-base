...
<link href="/Publicfont-awesome/css/font-awesome.css" rel="stylesheet" />
...
<div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5><?php echo ($meta_title); ?></h5>
             <div class="buttons">
                 <a class="btn btn-mini"  href="<?php echo U('Admin/Node/Index');?>">返回</a>
             </div>
           </div>
          <div class="widget-content ">
                    <form class="form-horizontal" <form action="<?php echo U('Admin/Node/addNode');?>" method="post">
