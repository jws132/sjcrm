...
<div class="main clearfix pt15">	 
	 	<div class="fl w700">
	 	    <div class="clearfix mb20 f12"><?php echo (L("T_YPP")); ?>:<?php echo (L("T_HOME")); ?> >> <?php echo (L("T_NEWS")); ?> >> <?php echo (news_list_type($info["pid"])); ?></div>
        ...
        <div class="fr w290 pr">
	 	    <div class="a-m-r"><?php echo (L("T_ABOUT")); ?></div>
	 		<div class="w250 w-a-bj pt70 ml10 p10">
	 		   <ul class="about-meun pt5 mb10">
                     <li><a href="/Index/about/id/1.html"><?php echo (along_type(L("T_ID_1"))); ?></a></li>
                     <li><a href="/Index/about/id/5.html"><?php echo (along_type(L("T_ID_5"))); ?></a></li>
                     <li><a href="/Index/about/id/6.html"><?php echo (along_type(L("T_ID_6"))); ?></a></li>
                     <li><a href="/Index/about/id/7.html"><?php echo (along_type(L("T_ID_7"))); ?></a></li>
                     <li><a href="/Index/about/id/8.html"><?php echo (along_type(L("T_ID_8"))); ?></a></li>
	 		   </ul>
