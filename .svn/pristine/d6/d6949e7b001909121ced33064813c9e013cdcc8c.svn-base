...
<div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5><?php echo ($meta_title); ?></h5>
             <div class="buttons">
              <a class="btn btn-mini"  href="<?php echo U('AddCase',array('pid'=>I('get.pid')));?>">新增</a>          
             </div>
           </div>
          <div class="widget-content ">
            <ul class="nav nav-tabs">
              <?php if(is_array(C("CASE_LIST_TYPE"))): $i = 0; $__LIST__ = C("CASE_LIST_TYPE");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newsType): $mod = ($i % 2 );++$i;?><li <?php if($news_id == $key): ?>class="active"<?php endif; ?> ><a href="<?php echo U('IndexCase',array('pid'=>$key));?>"><?php echo ($newsType); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <table class="table table-bordered table-striped with-check">
              ...
              <tbody>
                 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a href="<?php echo U('EditCase',array('id'=>$vo['id'],'pid'=>$vo['pid']));?>">编辑</a> | <a href="<?php echo U('delCase',array('id'=>$vo['id'],'pid'=>$vo['pid']));?>">删除</a></td>
