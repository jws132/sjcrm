...
<body>
  ...
  <div class="formbody">
    <div class="formtitle"><span><?php echo ($info['model_id']?'编辑':'新增'); ?>模型</span></div>
      ...
      <ul class="forminfo">
        ...
        <li><label>&nbsp;</label><input type="hidden" name="model_id" value="<?php echo ($info["model_id"]); ?>"><button class="btn btn-primary" type="submit">保存</button></li>
      </ul>
   </form>
    </div>
</body>
