	 	...
	 	<div class="fr w730">	
	 	    ...
	 	    <div class="clearfix pt20">
	 	    	...
	 	    	<ul class="w355 fl f12 pro-def">
	 	    		<li>产品编号：<font color="#ff6600"><?php echo ($info["number"]); ?></font></li>
	 	    		<li>产品名称：<font color="#ff6600"><?php echo ($info["title"]); ?></font></li>
	 	    		<li>规　　格：<font color="#ff6600"><?php echo ($info["spec"]); ?></font></li>
	 	    		<li>产品备注：<font color="#ff6600"><?php echo ($info["des"]); ?></font></li>
	 	    		<li>产品类别：<font color="#ff6600"><?php echo (pro_list_type($info["type"])); ?></font></li>
	 	    		<li>预览次数：<font color="#ff6600"><?php echo ($info["view"]); ?></font></li>
	 	    		<li>发布时间：<font color="#ff6600"><?php echo (date('Y-m-d',$info["create_time"])); ?></font></li>
	 	    	</ul>
	 	    </div>
	 	    <div class="clearfix col-data mt10 fb">&nbsp;&nbsp;产 品 说 明 </div>
