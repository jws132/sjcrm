...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav" style="font-size:12px;">
    ...
    <li class=""><a title="" href="?l=zh-cn"><i class="icon icon-cog"></i> <span class="text">中文</span></a></li>
    <li class=""><a title="" href="?l=en-us"><i class="icon icon-cog"></i> <span class="text">英文</span></a></li>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 控制台</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>案例管理</span> </a>
      <ul>
