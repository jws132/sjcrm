...
<body>
  ...
  <div class="place">
    ...
    <div class="tools">
      ...
      <ul class="toolbar">
        <li><a href="/index.php/Admin/Menu/Edit" ><span><img src="/Public/Admin/img/t01.png" /></span>添加</a></li>
     ...
     <table class="tablelist">
          ...
          <tbody>
            <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td align="center"><a href="/index.php/Admin/Menu/Edit/id/<?php echo ($vo["id"]); ?>" title="编辑" class="edit"></a><a href="/index.php/Admin/Menu/Del/id/<?php echo ($vo["id"]); ?>" title="删除" class="del"></a></td>
            </tr>
             <?php if(is_array($vo["child"])): $i = 0; $__LIST__ = $vo["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td align="center"><a href="/index.php/Admin/Menu/Edit/id/<?php echo ($c["id"]); ?>" title="编辑" class="edit"></a><a href="/index.php/Admin/Menu/Del/id/<?php echo ($c["id"]); ?>" title="删除" class="del"></a></td>
