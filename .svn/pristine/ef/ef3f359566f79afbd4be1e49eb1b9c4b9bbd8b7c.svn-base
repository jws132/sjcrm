     ...
     <table class="tablelist">
          ...
          <tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center"><a href="/index.php/admin/Article/Edit/id/<?php echo ($vo["id"]); ?>" title="编辑" class="edit"></a><a href="/index.php/admin/Article/Del/id/<?php echo ($vo["id"]); ?>" title="删除" class="del"></a></td>
