...
<div class="con-bg pt30">
    <div class="container">
        <ul class="nav_news_list clearfix">
            <?php if(is_array($channel)): $i = 0; $__LIST__ = $channel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <a href="/index.php/Home/<?php echo ($vo["model"]); ?>/index/id/<?php echo ($vo["id"]); ?>" class="<?php if($vo['id'] == $_GET['id']): ?>cursor<?php else: endif; ?>" ><?php echo ($vo["title"]); ?></a>
                </li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        <div class="news_list  clearfix">         
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul>
                <li>
                    <dl>
                        <dt><b><?php echo (date('d',$vo["createtime"])); ?></b> <br> <span class="english"><?php echo (date('m',$vo["createtime"])); ?>月</span></dt>
                        <dd>
