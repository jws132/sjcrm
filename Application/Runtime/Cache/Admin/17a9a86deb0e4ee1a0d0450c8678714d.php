...
<div class="widget-box">
          ...
          <div class="widget-content ">
                    <form class="form-horizontal" action="<?php echo U('EditLinks');?>" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name" value="<?php echo ((isset($info["name"]) && ($info["name"] !== ""))?($info["name"]):''); ?>"  style=" width:480px;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input  type="text" name="url" value="<?php echo ((isset($info["url"]) && ($info["url"] !== ""))?($info["url"]):''); ?>"  style=" width:480px;">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">网站简介</label>
                                        <div class="controls">
                                            <textarea name="conter" style=" width:480px;"><?php echo ((isset($info["conter"]) && ($info["conter"] !== ""))?($info["conter"]):''); ?></textarea>
                                        </div>
                                    </div>
                                    <?php if($info['pic'] != ''): ?><div class="control-group">
