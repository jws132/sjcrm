...
<div class="widget-box">
          ...
          <div class="widget-content ">
                    <form class="form-horizontal" action="<?php echo U('AddNews');?>" method="post" >
                                    <div class="control-group">
                                        <label class="control-label">分类</label>
                                        <div class="controls">
                                              <select name="pid">
                                                   <?php if(is_array(C("NEWS_LIST_TYPE"))): $i = 0; $__LIST__ = C("NEWS_LIST_TYPE");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newsType): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($news_id == $key): ?>selected<?php endif; ?>><?php echo ($newsType); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                              </select>        
                                        </div>
                                    </div>
                                    <div class="control-group">
