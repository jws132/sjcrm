...
<div class="widget-box">
          ...
          <div class="widget-content ">
                    <form class="form-horizontal" action="<?php echo U('Admin/Config/Edit');?>" method="post">
                                    <div class="control-group">
                                        <label class="control-label">配置标识</label>
                                        <div class="controls">
                                            <input type="text" name="name" class="span8" value="<?php echo ((isset($info["name"]) && ($info["name"] !== ""))?($info["name"]):''); ?>">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="title" class="span8" value="<?php echo ((isset($info["title"]) && ($info["title"] !== ""))?($info["title"]):''); ?>">
                                  ...
                                  <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="sort" class="span8" value="<?php echo ((isset($info["sort"]) && ($info["sort"] !== ""))?($info["sort"]):'0'); ?>">
                                  ...
                                  <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select name="type" class="span8">
                      											  <?php if(is_array(C("CONFIG_TYPE_LIST"))): $i = 0; $__LIST__ = C("CONFIG_TYPE_LIST");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if(($info['type'] == $key)): ?>selected="selected"<?php endif; ?> ><?php echo ($type); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                      								      </select>
                                 ...
                                 <div class="control-group">
                                        ...
                                        <div class="controls">
                                          <select name="group" class="span8">
                										        <?php if(is_array(C("CONFIG_GROUP_LIST"))): $i = 0; $__LIST__ = C("CONFIG_GROUP_LIST");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if(($info['group'] == $key)): ?>selected="selected"<?php endif; ?> ><?php echo ($group); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                										    </select>
                                 ...
                                 <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="value" class="span8" rows="5"><?php echo ((isset($info["value"]) && ($info["value"] !== ""))?($info["value"]):''); ?></textarea>
                                 ...
                                 <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="extra" class="span8" rows="5"><?php echo ((isset($info["extra"]) && ($info["extra"] !== ""))?($info["extra"]):''); ?></textarea>
                                 ...
                                 <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="remark" class="span8" rows="5"><?php echo ((isset($info["remark"]) && ($info["remark"] !== ""))?($info["remark"]):''); ?></textarea>
