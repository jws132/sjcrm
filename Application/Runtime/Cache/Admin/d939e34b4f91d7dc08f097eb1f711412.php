  ...
  <table class="tablelist">
          ...
          <tbody>
            <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><img src="/Uploads/Editor/<?php echo ($vo["img"]); ?>" border="0" /></td>
              <td align="center"><?php if($vo['status']): ?>开启<?php else: ?>关闭<?php endif; ?></td>
              <td align="center"><a href="/admin.php/Slide/edit/id/<?php echo ($vo["id"]); ?>" title="编辑" class="edit"></a><a href="/admin.php/Slide/del/id/<?php echo ($vo["id"]); ?>" title="删除" class="del"></a></td>
