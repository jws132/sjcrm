  ...
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>用户管理</span> </a>
      <ul>
        ...
        <li><a href="<?php echo U('Admin/System/Index');?>">日志管理</a></li>
      </ul>
    </li>
...
<div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            <h5><?php echo ($meta_title); ?></h5>
             <div class="buttons">
              <a class="btn btn-mini"  href="<?php echo U('Add');?>">新增设置</a>
                 
             </div>
           </div>
          <div class="widget-content ">
            <ul class="nav nav-tabs">
             <?php if(is_array(C("CONFIG_ACTION_LOG"))): $i = 0; $__LIST__ = C("CONFIG_ACTION_LOG");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?><li <?php if($log_id == $key): ?>class="active"<?php endif; ?> ><a href="<?php echo U('Index?type_log='.$key);?>"><?php echo ($log); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
