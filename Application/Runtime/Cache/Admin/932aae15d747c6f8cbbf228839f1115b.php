          ...
          <div class="widget-content ">
                    <form class="form-horizontal" action="<?php echo U('edit');?>" method="post">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                              <select name="pid">
                                                   <?php if(is_array(C("NEWS_LIST_TYPE"))): $i = 0; $__LIST__ = C("NEWS_LIST_TYPE");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newsType): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($info['pid'] == $key): ?>selected<?php endif; ?>><?php echo ($newsType); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                              </select>       
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <!--div class="control-group">
                                        ...
                                        <div class="controls">
                                          <select name="lang">
                                            <option value="zh-cn" <?php if($info['lang'] == 'zh-cn'): ?>selected<?php endif; ?>>中文</option>
                                            <option value="en-us" <?php if($info['lang'] == 'en-us'): ?>selected<?php endif; ?>>英文</option>
                                          </select> 
                                        </div>
                                    </div-->
                                    <div class="control-group">
